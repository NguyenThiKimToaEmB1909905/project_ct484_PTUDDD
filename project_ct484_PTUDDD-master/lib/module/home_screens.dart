  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 247, 152, 44),
        title: Text(
          "Trang chủ",
            ...
            children: [
              Container(
                ...
                decoration: const BoxDecoration(
                  color: Color.fromARGB(255, 247, 152, 44),
                ),
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            "3/2, Xuân khánh, Ninh Kiều, TP Cần Thơ",
                        ...
                        children: [
                          Text(
                            ...
                            style: GoogleFonts.poppins(
                                ...
                                color: Color.fromARGB(255, 253, 130, 29)),
                          ),
                          const Spacer(),
                        ],
                      ),
                      ...
                      child: GridView.builder(
                        gridDelegate:
                            const SliverGridDelegateWithFixedCrossAxisCount(
                                ...
                                mainAxisSpacing: 5,
                                crossAxisSpacing: 2,
                                childAspectRatio: 160.06 / 250.00),
